...
$(function() {
	...
	$(window).scroll(function(){
		...
		$(".aside a").each(function(k,v){
			$(v).click(function(){
				switch(k){
					case 0: $("html").scrollTop(1300);break;
					case 1: $("html").scrollTop(1900);break;
					case 2: $("html").scrollTop(2400);break;
					case 3: $("html").scrollTop(3000);break;
					case 4: $("html").scrollTop(3500);break;
					case 5: $("html").scrollTop(4000);break;
					case 6: $("html").scrollTop(4600);break;
					case 7: $("html").scrollTop(5100);break;
				}
			})
		})
